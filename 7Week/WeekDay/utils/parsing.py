...
def train_parse_args():
    ...
    parser.add_argument('--model_type', type=str, default='lenet', choices=['lenet', 'mlp', 'lenet_linear','lenet_multi', 'lenet_incept','vgg', 'resnet'], help='모델')
    
    #Lenet
    parser.add_argument('--mid_feature', type=int, default=2048, help='LeNet Linear 모델에서 중간 레이어 피쳐를 의미ㅏㅁ')

    #Vgg
    parser.add_argument('--vgg_type', type=str, default='A', choices=['A', 'B', 'C', 'D', 'E'], help='vgg 타입')

    #Resnet
    parser.add_argument('--resnet_type', type=str, default='18', choices=['18','34','50','101','152'], help='resnet 모델 타입')
