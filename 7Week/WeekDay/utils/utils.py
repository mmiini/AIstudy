...
def get_models(args):
    if args.model_type =='mlp':
        ...
        from networks.lenet_multi import lenetMulti
        model = lenetMulti(args.num_classes)

    elif args.model_type == 'lenet_incept':
        from networks.lenet_incept import lenetIncept
        model = lenetIncept(args.num_classes)

    elif args.model_type == 'vgg':
        from networks.myvgg import vgg
        model = vgg(args.vgg_type, args.num_classes, args.image_size)

    elif args.model_type == 'resnet':
        from networks.myresnet import resnet
        model = resnet(args.resnet_typ, args.num_classes, args.image_size)
