...
train_dataset = datasets.MNIST(root='/content/data/mnist', transform=ToTensor(), train=True, download=True)
test_dataset = datasets.MNIST(root='/content/data/mnist', transform=ToTensor(), train=False, download=True)
